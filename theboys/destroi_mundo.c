...
//Vai destruindo de cima pra baixo, em cada struct, se há uma outra struct com ponteiro, chama a função de destruição dela primeiro, tipo habilidades, presentes, fila de espera, etc. Depois libera a struct em si. Depois libera o vetor de ponteiros e no final libera a lef e o mundo.